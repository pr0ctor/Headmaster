...
namespace Headmaster.Controllers
{
    public class BuildingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BuildingID,Abbreviaion,BuidingName")] Buildings buildings)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BuildingID,Abbreviaion,BuidingName")] Buildings buildings)
        {
            if (ModelState.IsValid)
            {
